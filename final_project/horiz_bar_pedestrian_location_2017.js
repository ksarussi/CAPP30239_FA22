...
d3.csv("data/location_2017.csv").then(data => {
    ...
    let svg = d3.select("#horizontal-chart1") // resizing
        .append("svg")
    ...
    let y = d3.scaleBand()
        .domain(data.map(d => d.PEDPEDAL_LOCATION)) // d => is a loop. d = row of data. d.country = cell corresponding to country
    ...
    bar.append("rect") // add rect to bar group
        ...
        .attr("y", d => y(d.PEDPEDAL_LOCATION)) // y positioning
    ...
    bar.append('text') // add labels
        ...
        .attr('y', d => y(d.PEDPEDAL_LOCATION) + (y.bandwidth()/2))
